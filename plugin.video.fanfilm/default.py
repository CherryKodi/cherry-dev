...
elif action == 'FanFilm1':
    xbmc.executebuiltin("ActivateWindow(10001,plugin://plugin.program.super.favourites/?folder=FanFilm1,return)")
elif action == 'FanFilm2':
    xbmc.executebuiltin("ActivateWindow(10001,plugin://plugin.program.super.favourites/?folder=FanFilm2,return)")
elif action == 'tvPlayer':
    #from resources.lib.indexers import channels
    #channels.channels().get()
    xbmc.executebuiltin("ActivateWindow(10001,plugin://plugin.video.playlistLoader/,return)")
elif action == 'pair':
    #from resources.lib.indexers import channels
    #channels.channels().get()
    xbmc.executebuiltin('RunScript("special://home/addons/script.pair/addon.py")')
elif action == 'tvshows':
